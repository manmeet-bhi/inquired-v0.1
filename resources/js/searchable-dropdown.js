class SearchableDropdown {
    constructor(element, options = {}) {
        ...
        this.options = {
            searchUrl: options.searchUrl || '/api/companies/search',
    ...
    createDropdownHTML() {
        ...
        wrapper.innerHTML = `
            <div class="searchable-dropdown-container">
                <input type="text" 
                       class="searchable-dropdown-input w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    dropdowns.forEach(dropdown => {
        new SearchableDropdown(dropdown, {
            searchUrl: '/cms/api/companies/search',
