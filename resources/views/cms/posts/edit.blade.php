        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div class="text-sm text-slate-500 mb-4 bg-slate-50 p-3 rounded-lg">
                            <p class="flex justify-between mb-1">Created: <span class="font-medium text-slate-700">{{ $post->created_at->format('M d, Y') }}</span></p>
                            <p class="flex justify-between">Updated: <span class="font-medium text-slate-700">{{ $post->updated_at->format('M d, Y') }}</span></p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="tags" value="{{ old('tags', is_array($post->tags) ? implode(', ', $post->tags) : '') }}" 
                ...
                <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                    ...
                    <div class="mb-4">
                        <div class="relative group">
                            <img src="{{ $post->featured_image_url }}" alt="Current featured image" class="w-full h-40 object-cover rounded-lg border border-slate-200">
                        </div>
                    </div>
                    @endif
                        ...
                        <div class="relative">
                            ...
                            <div onclick="document.getElementById('featured-image-input').click()" 
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-sm text-slate-600">{{ $post->featured_image ? 'Replace image' : 'Click to upload' }}</p>
