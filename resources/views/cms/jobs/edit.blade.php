        ...
        <form action="{{ route('cms.jobs.update', $job) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="cms-form-group">
                    ...
                    <input type="text" id="job_id" name="job_id" value="{{ old('job_id', $job->job_id) }}" class="cms-input @error('job_id') border-red-500 @enderror" placeholder="e.g. JOB-1042, REQ-9821">
                    @error('job_id')
