...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.autoGenerateSchemaJson = function () {
        ...
        if (!type || (type !== 'static' && !id)) {
            alert('Please select a Page Type and Related Record first to auto-generate schema.');
            return;
        }
