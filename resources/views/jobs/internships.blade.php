...
@section('title', 'Internships - Start Your Career Journey')
...
<div class="bg-white">
    ...
    <main class="max-w-7xl mx-auto px-6 py-12">
        ...
        <aside class="w-full lg:w-80">
            <x-job-filters :categories="$categories" :showJobType="false" :showWorkType="true" salaryLabel="Stipend" />
        </aside>

        <!-- Main Content -->
        <div class="flex-grow">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xs font-black uppercase tracking-[0.3em] text-gray-400">Internships - {{ $jobs->total() }} Verified Vacancies</h2>
            ...
            <div class="border-t border-gray-100 mb-8">
                @foreach($jobs as $job)
                    <x-job-card :job="$job" layout="row" type="internship" />
                @endforeach
            </div>
            ...
            <div class="py-20 text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900">No internships found</h3>
