...
@section('title', 'Remote Jobs - Work From Anywhere')
    ...
    <main class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="flex-grow">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xs font-black uppercase tracking-[0.3em] text-gray-400">Remote Jobs - {{ $jobs->total() }} Verified Vacancies</h2>
            ...
            <div class="py-20 text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900">No remote jobs found</h3>
