...
@section('title', $company->name . ' Jobs - Find Opportunities')
...
<div class="bg-white">
    <main class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="lg:hidden mb-6">
            <button onclick="document.getElementById('filters-panel').classList.toggle('hidden')" class="w-full flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-900">
        ...
        <div class="flex flex-col lg:flex-row gap-6 lg:gap-16">
            ...
            <div class="flex-grow">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xs font-black uppercase tracking-[0.3em] text-gray-400">Showing {{ $jobs->total() }} Remote Positions</h2>
                ...
                <div class="py-20 text-center">
                    ...
                    <h3 class="text-lg font-bold text-gray-900">No active openings found</h3>
                    <p class="text-gray-500 mt-2">Adjust filters or subscribe to alerts for {{ $company->name }}.</p>
                </div>
                @endif
            </div>
        </div>
