        ...
        <div class="flex flex-col lg:flex-row gap-6 lg:gap-16">
            ...
            <div class="flex-grow">
                <div class="flex items-center justify-between mb-8">
                    <h2 class="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">{{ $companies->total() }} Growing Brands</h2>
                </div>
                ...
                <div class="py-20 text-center">
                    ...
                    <p class="text-gray-500 text-sm font-medium">New startups are being added regularly. Check back soon!</p>
                </div>
                @endif
            </div>
        </div>
