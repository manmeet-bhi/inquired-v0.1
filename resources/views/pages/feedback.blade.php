                ...
                @else
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 p-6 sm:p-10 shadow-sm hover:shadow-md transition-shadow" x-data="{ selectedRating: '{{ old('rating', 'good') }}' }">
                        ...
                        <form action="{{ route('feedback.submit') }}" method="POST" class="space-y-6">
                            ...
                            <!-- Testimonial Sharing Consent Checkbox -->
                            <div class="bg-blue-50/50 border border-blue-100 rounded-xl p-4 transition-all hover:bg-blue-50/80">
                                <label class="flex items-start gap-3 cursor-pointer">
                                    <input 
                                        type="checkbox" 
                                        name="agree_testimonial" 
                                        id="agree_testimonial" 
                                        value="Yes" 
                                        {{ old('agree_testimonial', 'Yes') === 'Yes' ? 'checked' : '' }}
                                        class="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 mt-0.5 cursor-pointer"
                                    >
                                    <div class="select-none">
                                        <span class="text-sm font-semibold text-gray-900 flex items-center gap-1.5">
                                            ...
                                            Agree to share your story as a testimonial
                                        </span>
                                        <p class="text-xs text-gray-500 mt-0.5 leading-relaxed">
                                            Allow Inaquired to feature your feedback and story on our Success Stories & Testimonials page.
                                        </p>
                                    </div>
                                </label>
                            </div>
