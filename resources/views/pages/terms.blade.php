...
<div class="bg-white">
    ...
    <main class="max-w-4xl mx-auto px-6 py-12">
        <div class="bg-white rounded-2xl border border-gray-100 p-8 space-y-8">
            ...
            <!-- User Accounts -->
            <section>
                <h2 class="text-2xl font-bold text-gray-900 mb-4">User Experience</h2>
                <div class="space-y-4">
                    <div>
            ...
            <!-- Prohibited Uses -->
            <section>
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Prohibited Uses</h2>
                <p class="text-gray-600 leading-relaxed mb-4">You may not use our service:</p>
                <ul class="list-disc list-inside text-gray-600 space-y-2">
            ...
            <!-- Job Postings -->
            <section>
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Job Postings</h2>
                <div class="space-y-4">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">For Employers</h3>
                        <p class="text-gray-600 leading-relaxed">
            ...
            <section>
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Accuracy of Listings</h2>
                <p class="text-gray-600 leading-relaxed">
